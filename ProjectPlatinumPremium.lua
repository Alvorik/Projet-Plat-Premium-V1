...
-- Updates Etc.
local Upd = Window:NewTab("Upd, Info")
local UpdSection = Hub:NewSection("Updates Info | Project Plat Premium")

UpdSection:NewButton("Creator Etc.", "Script Created by Alvorikk", function()
	print(ScriptCreatedByAlvorik)
end)

UpdSection:NewButton("Update V5", "Welcome to Project Plat Premium Official ScriptHub", function ()
	print(UpdV5Info)
end)
